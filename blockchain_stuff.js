...
const HELLO_WORLD_CONTRACT_ADDRESS = "0xD9BcFd43E6BA76b1468D0a66325C0c06D6DACf33"
  ...
  var awaitWeb3 = async function () {
    ...
    web3.eth.net.getId((err, netId) => {
      if (netId == NETWORK_ID) {
        ...
        document.getElementById("web3_message").textContent="Please connect to Scroll L2 Testnet";
      }
    });
  };
  awaitWeb3();
